        ...
        <div class="bg-[#2A2F3C] rounded-lg shadow-xl p-8 mb-8 transition-all duration-300 hover:shadow-2xl">
          ...
          <div class="space-y-6">
            ...
            <div class="border border-[#3A3F4C] rounded-lg overflow-hidden">
              <div class="bg-gradient-to-r from-[#2A2F3C] to-[#252A36] p-4 flex justify-between items-center cursor-pointer">
              ...
              <div class="bg-[#1A1F2C] p-6 border-t border-[#3A3F4C]">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="space-y-2">
                    ...
                    <input type="text" class="w-full bg-[#252A36] border border-[#3A3F4C] rounded p-2 text-white" disabled placeholder="John Doe" />
                  </div>
                  <div class="space-y-2">
                    <label class="block text-sm text-[#8E9196]">DIN Portfolio</label>
                    <select class="w-full bg-[#252A36] border border-[#3A3F4C] rounded p-2 text-white" disabled>
          ...
          <div class="mt-8 text-center">
            <button 
              class="px-8 py-4 bg-[#9b87f5] hover:bg-[#8b77e5] text-white font-bold rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
